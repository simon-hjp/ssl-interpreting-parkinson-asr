...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='huBERT-based Feature Embedding Extraction', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    nlayers = [7]
    for i in nlayers:
        feature_output_dir = os.path.join(args.output_dir, 'hubert', f'layer{str(i).zfill(2)}')
    ...
    for wav_path in tqdm(wav_paths):
        ...
        if waveform_seconds > 60:
            ...
            for layer_id in nlayers:
                ...
                output_path = os.path.join(args.output_dir, 'hubert', f'layer{str(layer_id).zfill(2)}', sample_id)
